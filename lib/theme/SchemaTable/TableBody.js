...
function TBody({
  ...
  return <tbody {...props} className={(0, _clsx.default)(_stylesModule.default.tbody, props === null || props === void 0 ? void 0 : props.className)}>
      {tableData.map((row, index) => {
      const isSubfieldTableOpen = openRows.includes(index);
      return <_react.Fragment key={row.field}>
            <tr
        // className={clsx(
        //   "w-full",
        //   subfieldLevel % 2 ? "bg-neutral-100" : "bg-white"
        // )}
        className={(0, _clsx.default)(_stylesModule.default.tr, !subfieldLevel && index === tableData.length - 1 && _stylesModule.default.hasBottomBorder)} style={{
          ...
          className={(0, _clsx.default)(_stylesModule.default.fieldTh, _stylesModule.default.td)} style={{
            paddingLeft: `${(subfieldLevel + 1) * PADDING_LEFT}px`
                ...
                {row.subfields ? <button className={(0, _clsx.default)("button", "button--secondary", _stylesModule.default.subfieldButton)}
            ...
            >
              ...
              // )}
              className={(0, _clsx.default)(_stylesModule.default.subfieldButtonIcon)} style={{
                transform: `rotate(${isSubfieldTableOpen ? "0deg" : "180deg"})`
              }} />
          ...
          className={_stylesModule.default.requiredTh}>
                <Required isRequired={row.required} />
              </td>
              <td
          // className="w-[76px] p-0 text-xs text-neutral-700"
          className={(0, _clsx.default)(_stylesModule.default.typeTh, _stylesModule.default.tdType)}>
            ...
            {row.subfields && (isSubfieldTableOpen ? <_TableRow.TR row={row} index={index} subfieldLevel={subfieldLevel + 1} /> : null)}
          </_react.Fragment>;
    })}
    </tbody>;
}
function Required({
  ...
  return <div className={(0, _clsx.default)(_stylesModule.default.requiredBubble, isRequired && _stylesModule.default.isRequired)}>
...
function Chevron(props) {
  return <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" {...props}>
      <path fill="rgba(0,0,0,0.5)" d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z"></path>
    </svg>;
}